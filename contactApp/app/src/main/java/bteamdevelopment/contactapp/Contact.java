...
public class Contact extends ArrayList<Contact> {
    ...
    public Contact(int id, String fname, String lname, String mobile, String home, String email, String address, String city, String state, String zip, byte[] _image){
        this.id = id;
        this.fName = fname;
        this.lName = lname;
        this.mobile = mobile;
    ...
    public void setImage(byte[] _image) { this._image = _image; }
